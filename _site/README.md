# [LZN's Tech Blog Based on Jekyll](https://novarizark.github.io) 

**This repo is my own tech blog. It records everything about my work, interests, side projects, and everything else**

>Before Dec 2017, all my tech blogs, based on WordPress, are hosted on a lab server in the east campus of Sun Yat-sen University. Although I didn't have a domain name, accessing the blog by IP and a specific port works fine. Unfortunately, on Sep 2017, the port was turned off due to irresistible reasons. At that time, I was still a naïve boy, believing that it was okay if I can access my blog from the intranet. The tragedy happened on Nov 2017, when I found I couldn’t access my blog anymore from the campus intranet. Therefore, I went back to the lab in east campus, only to find that the BOTH RAID1 hard disks were damaged heavily! I tried everything to recover the data, all the blogs from Jul 2014 to Sep 2017 were lost. 

>There is no use to regret my loss and ignorance to the negative “black swan”, regarding my requirement to the cost, flexibility, stability, and accessibility from certain regions in the world, I finally choose GitHub Pages as the host. Hopefully, even someday I pass away, all the text can still be available on the internet, as an epitaph or something.

>On April 13th, good news finally came! Before the fatal moment of the disks, I finally rescued almost all the blog texts and uploads. Thank God!


**The webpages is generated by jekyll, a tool to transform plain text into static websites and blogs. The blog theme was forked from HyG's design, you may find the original theme readme below. Thanks for his great efforts!**

------

## Below is for the theme readme
